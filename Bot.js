...
import * as WhoAreYouManager from './scripts/who-are-you-manager.js'
import * as ImageManager from './scripts/image-manager.js'
...
async function init()
{
	...
	DataManager.WhoAreYouManager = WhoAreYouManager;
	DataManager.ImageManager = ImageManager;

	WhoAreYouManager.init(DataManager)
